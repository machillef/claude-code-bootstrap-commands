...
- Can complement the execution-loop's `security-reviewer` agent with deeper tool-assisted scanning
- Review-loop Pass 3 (Risk + Security) evaluates code during review; `/security-audit` provides proactive tool-assisted scanning independent of a review cycle
