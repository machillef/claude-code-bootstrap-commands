...
- **QoS class mismatch**: Requests and limits not aligned for intended QoS class
...
- **Missing startup probe**: Slow-starting applications without `startupProbe`
...
- **Missing ResourceQuota**: Namespaces without resource quotas
...
- **Missing chart tests**: No `templates/tests/` directory
