...
Known failure patterns accumulated from real usage. These are auto-consolidated from `~/.claude/skills/learned/` and manual observations.

Claude: read these before starting any slice. They represent mistakes that have happened before.
